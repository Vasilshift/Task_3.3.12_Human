...
//     Создайте 3 конструктора в классе Human, 1-ый - пустой,
//     2-ой, который конструирует Human’a от всех полей и третий,
...
public class Task3312 {
    public static void main(String[] args) {
        ...
        Human Sasha = new Human((byte) 32, "Sasha", "Iurin", "tennis");
        Human Sergei = new Human((byte) 44, "Sergei", "Kilin");
